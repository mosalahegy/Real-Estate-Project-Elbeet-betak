                ...
                <!-- Sidebar toggle button-->
                    ...
                    <div class="navbar-custom-menu">
                        ...
                        <li class="dropdown messages-menu">
                                ...
                                <span class="label label-success">{{count(getLastFiveMessages())}}</span>
                                </a>
                            <ul class="dropdown-menu">
                                <li class="header">اخر 5 رسائل</li>
                                        <li>
                                            <!-- inner menu: contains the actual data -->
                                            <ul class="menu">
                                                @foreach(getLastFiveMessages() as $message)
                                                    <li>
                                                        <a href="adminpanel/contact/7/edit">
                                                            <div class="pull-right">
                                                                <img src="{{asset('admin/dist/img/user3-128x128.jpg')}}" class="img-circle" alt="User Image">
                                                            </div>
                                                            <h4>
                                                            <span style="margin-right: 10px;">{{$message->contact_name}}</span>
                                                                <small><i class="fa fa-clock-o"></i>{{$message->created_at}}</small>
                                                            </h4>
                                                        <p style="">{{str_limit($message->contact_message,20)}}</p>
                                                        </a>
                                                    </li>
                                                @endforeach
                                            </ul>
                                ...
                                <li class="footer"><a href="#">رؤية كل الرسائل</a></li>
                            </ul>
                        </li>
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    ...
                    <div class="pull-right info">
                        <p>{{Auth::user()->name}}</p>
                        <a href="#"><i class="fa fa-circle text-success" style='color: #2ABB9B;'></i> متاح الان</a>
                    </div>
                </div>
                <!-- search form -->
