    ...
    <div class="form-group{{ $errors->has('small_desc') ? ' has-error' : '' }}">
        <div class="col-md-8 col-md-offset-2">
                <textarea id="small_desc" type="text" class="form-control" rows="3" placeholder="وصف قصير للعقار" name="small_desc" required autofocus>{{ $building->small_desc }}</textarea>
    ...
    <div class="form-group">
        <div class="col-md-8 col-md-offset-2">
            <button type="submit" class="btn btn-success">
                <i class="fa fa-edit" style="color:#FFF;margin-bottom: 1px;"> </i>  تعديل عقار جديد
            </button>
        </div>
    </div>   
