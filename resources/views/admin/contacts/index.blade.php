...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"><a href="/adminpanel/users">جميع الرسائل</a></li>
        </ol>
      </section>
                      ...
                      <table id="example2" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th><span style='margin-left: 85px;font-size: 15px;margin-right: -27px;'>اسم المرسل</span></th>
                                    <th><span style='margin-left: 85px;font-size: 15px;margin-right: -27px;'>البريد الالكترونى</span></th>
                                    <th><span style='margin-left: 85px;font-size: 15px;margin-right: -27px;'>الموضوع</span></th>
                                    <th><span style='margin-left: 85px;font-size: 15px;margin-right: -27px;'>المحتوى</span></th>
                            ...
                            <tbody>
                                @if(count($contacts) > 0)
                                    ...
                                    <tr>
                                        <td>{{$contact->id}}</td>
                                        <td><a href="/adminpanel/contact/{{$contact->id}}/edit">{{$contact->contact_name}}</a></td>
                                        <td>{{$contact->contact_email}}</td>
                                        <td>{{$contact->contact_subject}}</td>
                                        <td>{{$contact->contact_message}}</td>
                                        <td>
                                          <a href='/adminpanel/contact/{{$contact->id}}/edit' class='btn btn-success'>تعديل</a>                                              
                                          <a href='/adminpanel/contact/{{$contact->id}}/delete' class='btn btn-danger'>حذف</a>    
                                        </td>
                                    </tr>
                                    @endforeach
                                @endif
